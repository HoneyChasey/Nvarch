...
local servers = { "html", "cssls", "bashls", "clangd", "dockerls", "gopls", "jdtls", "lua_ls", "pyright", "svelte", "nil_ls"} -- Write here all the the name of lsp you want to enable. To get their name, please refer to https://github.com/neovim/nvim-lspconfig--
